...
struct CodeEmissionTests {
    ...
    @Test func propertyAssignmentMemberInjectionEmitsAsDirectAssignmentAfterConstruction() {
        ...
        let expected = """
            ...
            internal struct _WireGraph: Introspectable {
                let view: View
    ...
    @Test func singleContainerEmitsItsOwnStructAlongsideEmptyDefault() {
        ...
        let expected = """
            ...
            internal struct _TestContainerWireGraph: Introspectable {
                let logger: Logger
    ...
    @Test func multipleContainersAreEmittedInSortedOrder() {
        ...
        let expected = """
            ...
            internal struct _AlphaWireGraph: Introspectable {
                let a: A
            ...
            internal struct _BravoWireGraph: Introspectable {
                let b: B
    ...
    @Test func opaqueBindingsLiftGenericParametersOntoWireGraph() {
        ...
        let expected = """
            ...
            internal struct _WireGraph<T0: DBTable & Sendable, T1: TaskRepo, T2: API>: Introspectable {
    ...
    @Test func structuralLiftNodeReusesBridgeTargetParameterAsNestedField() {
        ...
        let expected = """
            ...
            internal struct _WireGraph<T0: DBTable & Sendable, T1: TaskRepo>: Introspectable {
                let someDBTableSendable: T0
                let someTaskRepo: T1
    ...
    @Test func multiParamStructuralLiftNodeSubstitutesEachParameterIndependently() {
        ...
        let expected = """
            ...
            internal struct _WireGraph<T0: TaskRepo, T1: Logger>: Introspectable {
                let someTaskRepo: T0
                let someLogger: T1
