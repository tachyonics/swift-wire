...
Milestones are tied to what task-cluster needs next, not a fixed calendar. The full roadmap — milestone-by-milestone (M0–M6 and post-1.0), plus pre-1.0 polish, deferred features, and post-M1 design previews — lives in [ROADMAP.md](ROADMAP.md). M0 and M1 are complete.
