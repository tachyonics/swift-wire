...
/// build plugin. Extracted from `BindingDiscovery.swift`. Includes
/// SE-0491 module-selector tolerance so a user may qualify Wire's macros
/// with its module (`@Wire::Singleton`) — see `wireMacroNameMatches` and
